import { ExternalLink, Star, Github, Youtube, Globe, BookOpen, Award, FileText, MessageCircle, Gift } from "lucide-react";
...
const ResourceCard = ({ resource, index }: ResourceCardProps) => {
  ...
  return (
    <motion.a
      ...
      className="group block bg-card border border-border rounded-xl p-5 hover:border-primary/30 hover:shadow-glow transition-all duration-300"
    >
